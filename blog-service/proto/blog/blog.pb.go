...
const file_blog_blog_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteBlog\x12\x18.blogs.DeleteBlogRequest\x1a\x19.blogs.DeleteBlogResponse\"\x17\x82\xd3\xe4\x93\x02\x11*\x0f/api/blogs/{id}B\x11Z\x0fproto/blog;blogb\x06proto3"
...
var file_blog_blog_proto_depIdxs = []int32{
	...
	0, // 8: blogs.BlogService.GetBlog:output_type -> blogs.BlogDto
	9, // 9: blogs.BlogService.UploadImage:output_type -> blogs.UploadImageResponse

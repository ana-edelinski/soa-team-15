...
const file_stakeholders_stakeholders_proto_rawDesc = "" +
	"\n" +
	"\x1fstakeholders/stakeholders.proto\x12\fstakeholders\x1a\x1cgoogle/api/annotations.proto\"F\n" +
...
var file_stakeholders_stakeholders_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_stakeholders_stakeholders_proto_depIdxs = []int32{
	0, // 0: stakeholders.StakeholdersService.Login:input_type -> stakeholders.LoginRequest
	2, // 1: stakeholders.StakeholdersService.RegisterTourist:input_type -> stakeholders.RegisterRequest
	1, // 2: stakeholders.StakeholdersService.Login:output_type -> stakeholders.LoginResponse
	1, // 3: stakeholders.StakeholdersService.RegisterTourist:output_type -> stakeholders.LoginResponse

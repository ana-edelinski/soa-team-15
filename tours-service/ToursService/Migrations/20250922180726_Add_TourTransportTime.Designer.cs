...
namespace ToursService.Migrations
{
    ...
    [Migration("20250922180726_Add_TourTransportTime")]
    partial class Add_TourTransportTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToursService.Domain.TourExecution", b =>
                {
                    ...
                    b.Property<List<CompletedKeyPoint>>("CompletedKeys")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("ToursService.Domain.TourExecution", b =>
                {
                    b.HasOne("ToursService.Domain.Position", null)
                        .WithMany()
